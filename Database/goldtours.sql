...
-- Database: `goldtours`
--
CREATE DATABASE IF NOT EXISTS `goldtours` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `goldtours`;
...
(6, 'Barcelona Beach Paradise', 'Experience the vibrant culture and beautiful beaches of Barcelona', 'Barcelona, Spain', 1600.00, 5, 20, '2024-11-01', '2024-11-05', 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=800&h=400&fit=crop', 1, '2025-11-22 14:09:05', '2025-11-22 14:09:05'),
(7, 'Dubai Luxury Escape', 'Indulge in the opulence and modernity of Dubai', 'Dubai, UAE', 3200.00, 6, 12, '2024-11-15', '2024-11-20', 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&h=400&fit=crop', 1, '2025-11-22 14:09:05', '2025-11-22 14:09:05'),
(8, 'Sydney Harbour Experience', 'Discover the iconic landmarks of Sydney', 'Sydney, Australia', 2800.00, 7, 16, '2024-12-01', '2024-12-07', 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=800&h=400&fit=crop', 1, '2025-11-22 14:09:05', '2025-11-22 14:09:05'),
(9, 'Amsterdam Canal Cruise', 'Explore the charming canals and rich history of Amsterdam', 'Amsterdam, Netherlands', 1400.00, 4, 24, '2024-12-10', '2024-12-13', 'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=800&h=400&fit=crop', 1, '2025-11-22 14:09:05', '2025-11-22 14:09:05'),
(10, 'Santorini Sunset Magic', 'Witness breathtaking sunsets in the Greek islands', 'Santorini, Greece', 1900.00, 5, 14, '2025-01-05', '2025-01-09', 'https://images.unsplash.com/photo-1613395877344-13d4a8e0d49e?w=800&h=400&fit=crop', 1, '2025-11-22 14:09:05', '2025-11-22 14:09:05'),
(11, 'Bali Tropical Paradise', 'Relax and rejuvenate in the tropical beauty of Bali', 'Bali, Indonesia', 2200.00, 8, 18, '2025-01-15', '2025-01-22', 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800&h=400&fit=crop', 1, '2025-11-22 14:09:05', '2025-11-22 14:09:05'),
(12, 'Kyiv Live Ukraine', 'Experience the vibrant culture and rich history of Kyiv, Ukraine\'s capital', 'Kyiv, Ukraine', 1500.00, 5, 20, '2025-02-01', '2025-02-05', 'https://images.unsplash.com/photo-1650046300363-93a34e4e3447?q=80&w=1334&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 1, '2025-11-22 14:09:05', '2025-11-22 14:09:05');
